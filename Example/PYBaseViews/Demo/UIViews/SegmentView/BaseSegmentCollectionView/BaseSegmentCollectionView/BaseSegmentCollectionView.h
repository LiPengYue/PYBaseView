...
@interface BaseSegmentCollectionView : UICollectionView

@property (nonatomic,weak) id <BaseSegmentContentViewDelegate>contentViewDelegate;
@property (nonatomic,weak) id<BaseSegmentTagViewDelegate>tagViewDelegate;
